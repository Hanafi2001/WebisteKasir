<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      &nbsp;&nbsp;
      <!-- Tombol export excel-->
      <a href="#" data-target="#ModalCetakEXCEL" data-toggle="modal" class="btn btn-success btn-icon-split"><span class="text"><i class="fas fa-file-excel"></i> Export Excel</span></a>
